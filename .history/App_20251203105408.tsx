    ...
    <div className="relative h-screen w-screen bg-black text-white overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 z-30 flex flex-col items-center justify-center text-center px-4 pointer-events-none">
        <div className="space-y-4">
            ...
            <h1 className="text-5xl md:text-7xl font-serif text-green-500 tracking-tight drop-shadow-2xl animate-fade-in">
                Happy Holidays
            </h1>
            <div className="w-10 bg-white/40 mx-auto my-3" />
            {/* 修正点: text-white/200 を text-white に修正しました */}
            <p className="text10px md:text-2xl font-light text-white tracking-[0.25em] uppercase animate-fade-in">
