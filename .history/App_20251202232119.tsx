  ...
  return (
    <div className="relative h-screen w-screen bg-white text-white overflow-hidden font-sans">
      ...
      <div className="absolute top-8 left-8 z-30 animate-fade-in">
        <div className="border border-white/50 bg-white/10 backdrop-blur-md px-6 py-3 min-w-[120px] text-center">
            <span className="text-white font-serif tracking-widest text-sm uppercase">
                <img src="res/file/interface/h1-logo.png" alt="TARO ASHIHARA ARCHITECTS"></img>
            </span>
        </div>
      </div>
