...
const visualHighlights = [
  {
    id: 1,
    image: "./public/public/img/bg-city.jpg",
    label: "Kagawa, 2025-03",
    title: "カトーレック高松工場",
  },
  {
    id: 2,
    image: "./public/img/bg-newyear.jpg",
    label: "Kagawa, 2025-03",
    title: "カトーレック高松工場",
  },
  {
    id: 3,
    image: "./public/img/bg-winter.jpg",
    label: "Kagawa, 2025-03",
    title: "カトーレック高松工場",
  },
  {
...
const App: React.FC = () => {
  ...
  // BGM URL
  const MUSIC_URL = "./publc/audio/to-my-precious-person-291357.mp3"; 
