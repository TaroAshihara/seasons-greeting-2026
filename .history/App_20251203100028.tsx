...
const visualHighlights = [
  {
    ...
    label: "Minato-ku, Tokyo", // 場所やカテゴリーなどの補足
    title: "Urban Complex 2024", // プロジェクト名
  },
  {
    id: 2,
  ...
  },
  {
    ...
    label: "Karuizawa, Nagano",
    title: "Forest Villa Project",
  }
];
    ...
    <div className="relative h-screen w-screen bg-black text-white overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 z-30 flex flex-col items-center justify-center text-center px-4 pointer-events-none mix-blend-screen">
        <div className="space-y-4">
            ...
            <p className="text-[10px] md:text-xs font-light text-white/70 tracking-[0.25em] uppercase animate-fade-in">
      ...
      <div className="absolute bottom-8 right-8 z-30 text-right">
        {visualHighlights.map((item, index) => (
           <div 
             ...
             className={`absolute bottom-0 right-0 w-full min-w-[200px] transition-opacity duration-[2500ms] ease-in-out ${
