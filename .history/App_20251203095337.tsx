...
// ▼ 画像ごとのテキスト（キャプション）はここで設定します
const visualHighlights = [
  {
    id: 1,
    image: "./img/bg-city.jpg",
    // 以下を変更すると、1枚目の画像のテキストが変わります
    label: "PROJECT 01",
    title: "Urban Harmony",
    description: "都市と自然が調和する、新しいランドスケープ。"
  },
  {
    id: 2,
    ...
    description: "本年も変わらぬご愛顧を心よりお願い申し上げます。"
  },
  {
    id: 3,
    ...
    label: "VISION 2025",
    title: "Future Design",
    description: "次世代へ繋ぐ、持続可能な建築を目指して。"
  }
];
